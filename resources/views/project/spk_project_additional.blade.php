...
@section('title', 'SPK Project Tambahan')
...
<div class="page-header">
  <div class="row align-items-center">
    <div class="col">
      <h3 class="page-title">Data SPK Project Tambahan</h3>
      <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="index-2.html">SPK Project Tambahan</a></li>
        <li class="breadcrumb-item active">Data SPK Project Tambahan</li>
      </ul>
    </div>
    ...
    <div class="col-md-12 d-flex">
      <div class="card card-table flex-fill">
        <div class="card-header">
          <h3 class="card-title mb-0">SPK Project Tambahan</h3>
        </div>
...
<div class="row">
  <div class="col-md-12 d-flex">
    <div class="card card-table flex-fill">
        <div class="card-body ml-3 mt-3 mr-3 mb-3">
            @foreach ($spk_project_adtts as $val)
...
if($('.date').length > 0) {
    ...
    $.ajax({
        type: 'GET',
        url: url+'number/generate?prefix=SPKP',
...
$(document).ready(function(){
    var spk_project_id = "{{ $spk_project_id }}";
    $('form#add-form').submit(function(e) {
        ...
        $.ajax({
            type: 'post',
            url: BASE_URL+'/spk-project/'+spk_project_id+'/additional',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
    ...
    $(document).on('click', '#delete', function(e){
        ...
        var id = $(this).data("id");
        console.log(BASE_URL+'/spk-project/'+spk_project_id+'/additional/'+id+'/delete');
        swal({
            ...
            confirmButtonText: 'Hapus'
                ...
                $.ajax({
                    type: 'get',
                    url: BASE_URL+'/spk-project/'+spk_project_id+'/additional/'+id+'/delete',
                    cache: false,
                    contentType: false,
                    processData: false,
                    dataType: 'json',
