          ...
          <div class="form-group row">
            ...
            <div class="col-md-10">
              <select id="input-type" name="type">
                ...
                <option value="lot" {{$rap->type == 'lot' ? 'selected' : ''}}>Kapling</option>
                <option value="fasum" {{$rap->type == 'fasum' ? 'selected' : ''}}>Fasum</option>
                <option value="fasos" {{$rap->type == 'fasos' ? 'selected' : ''}}>Fasos</option>
              </select>
            </div>
          </div>
          <div class="form-group row">
