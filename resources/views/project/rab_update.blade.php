  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0">Update RAB</h4>
      </div>
      <form id="add-form" method="POST" action="#">
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-10">
              <input class="form-control floating" type="text" id="input-title" name="title" value="{{ $rab->title }}">
            ...
            <div class="col-md-10">
              <select id="input-cluster" name="cluster_id">
                ...
                @foreach($clusters as $cluster)
                  <option value="{{$cluster['id']}}" @if ($cluster['id'] == $rab->cluster_id)
                      selected
          ...
          <section class="review-section">
            <div class="review-header text-center">
              <h3 class="review-title">Item RAB</h3>
              <p class="text-muted">Silahkan masukkan poin - poin RAB</p>
            </div>
            <div class="row">
              <div class="col-md-12">
        ...
        if(msg.status == 'success'){
            setTimeout(function() {
                swal({
                    ...
                    window.location.replace("{{url('/rab')}}");
                });
            }, 500);
        } else {
            swal({
