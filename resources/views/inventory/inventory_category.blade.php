...
<div class="page-header">
  <div class="row align-items-center">
    <div class="col">
      ...
      <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="index-2.html">Kategori Barang</a></li>
        <li class="breadcrumb-item active">Data Kategori Barang</li>
      </ul>
    </div>
    <div class="col-auto float-right ml-auto">
      <a href="#" class="btn add-btn" id="show-add-modal"><i class="fa fa-plus"></i> Tambah Kategori Barang</a>
    </div>
  </div>
</div>
<!-- /Page Header -->
  ...
  <div class="col-md-12 d-flex">
    <div class="card card-table flex-fill">
      <div class="card-header">
        <h3 class="card-title mb-0">Kategori Barang</h3>
      </div>
...
<script type="text/javascript">
  ...
  $("#main-table").DataTable({
      ...
      "serverSide": true,
      "ajax":{
          "url": BASE_URL+"/inventory-category-datatables",
          "dataType": "json",
          "type": "POST",
          "data":function(d) { 
            d._token = "{{csrf_token()}}"
  ...
  $('form#add-form').submit( function( e ) {
    ...
    $.ajax({
      type: 'post',
      url: BASE_URL+'/inventory-category',
      data: form_data,
      cache: false,
      contentType: false,
      processData: false,
