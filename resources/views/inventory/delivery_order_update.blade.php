  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0">Ubah Surat Jalan</h4>
      </div>
      <form id="add-form" method="POST" action="#">
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-10">
              <input class="form-control floating" type="text" id="input-number" name="number" value="{{ $order->number }}">
              <input class="form-control floating" type="hidden" name="id" value="{{ $order->id }}">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-form-label col-md-2">Tanggal</label>
            <div class="col-md-10">
              <input class="form-control floating" type="text" id="input-date" name="date" value="{{ $order->date }}">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-form-label col-md-2">Nama Penerima</label>
            <div class="col-md-10">
              <input class="form-control floating" type="text" id="input-dest-name" name="dest_name" value="{{ $order->dest_name }}">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-form-label col-md-2">Alamat Penerima</label>
            <div class="col-md-10">
              <input class="form-control floating" type="text" id="input-dest-address" name="dest_address" value="{{ $order->dest_address }}">
            </div>
          </div>
