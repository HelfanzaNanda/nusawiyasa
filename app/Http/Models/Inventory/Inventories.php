...
class Inventories extends Model
{
     ...
     */
    protected $fillable = [
        'name', 'stock', 'category_id', 'unit_id', 'purchase_price', 'type', 'is_active', 'is_deleted', 'created_at', 'updated_at', 'brand'
    ];
     ...
     */
    protected $casts = [
        'name' => 'string', 'category_id' => 'int', 'unit_id' => 'int', 'purchase_price' => 'double', 'type' => 'string', 'is_active' => 'boolean', 'is_deleted' => 'boolean', 'created_at' => 'timestamp', 'updated_at' => 'timestamp', 'brand' => 'string'
    ];
