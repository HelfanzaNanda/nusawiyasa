 ...
 */
class WorkAgreementAdditionals extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'spk_worker_additionals';
     ...
     */
    protected $fillable = [
        'id', 'spk_worker_id', 'number', 'title', 'date', 'filepath', 'filename', 'create_by_user_id', 'approved_by_user_id', 'received_by_user_id', 'created_at', 'updated_at'
    ];
     ...
     */
    protected $casts = [
        'filepath' => 'string',  'filename' => 'string',  'spk_worker_id' => 'int',  'create_by_user_id' => 'int', 'approved_by_user_id' => 'int', 'received_by_user_id' => 'int',
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            ...
            'spk_worker_id' => ['alias' => $model->table.'.spk_worker_id', 'type' => 'int'],
        ...
        if ($request->file('file')) {
            ...
            if ($check) {
                ...
                self::create([
                    ...
                    'number' => $params['number'],
                    'date' => $params['date'],
                    'spk_worker_id' => $params['spk_worker_id'],
                    'filepath' => '/storage/media/work-agreement/'.$month_year_pfx,
                    'filename' => $filename,
                ]);
            } else {
