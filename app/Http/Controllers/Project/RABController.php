...
class RABController extends Controller
{
    ...
    public function insertData(Request $request)
    {
        ...
        return Rab::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = Rab::datatables($start, $limit, $order, $dir, $search, $filter, $session);
        ...
        if (!empty($res['data'])) {
            foreach ($res['data'] as $row) {
                ...
                $nestedData['action'] .='                <a class="dropdown-item" href="'.asset('update-rab/'.$row['id']).'"><i class="fa fa-pencil m-r-5"></i> Edit</a>';
